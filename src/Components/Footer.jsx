...
export default function Footer() {
    return (
        <footer
            className="border-y"
        >
            <div className="mx-auto w-95 max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-red-500 hover:text-red-400 uppercase">Resources</h2>
                            <ul className="
                            ...
                            hover:text-[#c25151]">
                                ...
                                <li>
                                    <a href="/About" className=" text-red-500 hover:text-red-400 font-semibold ">
                                        About
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold  text-red-500 hover:text-red-400 uppercase">Follow us</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold  text-red-500 hover:text-red-400 uppercase">Legal</h2>
                            <ul className=" text-red-500 hover:text-red-400 font-medium">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-red-500 hover:text-red-400 sm:text-center">
                        © 2024 PDF EDIT. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <a href="#" className="text-red-500 hover:text-blue-400">
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                        ...
                        <a href="https://wa.me/+918010126446" className="text-red-500 hover:text-green-500">
  <svg
    className="w-5 h-5"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
<a href="https://www.instagram.com/chocolatetiffin?igsh=MTNtMHdibHVmNXAyaA==" className="text-red-500 hover:text-pink-500">
  <svg
    className="w-5 h-5"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
